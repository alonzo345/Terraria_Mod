...
namespace TerrariaPlus.Items.Tools.Rusty
{
	public class RustyAxe : ModItem
	{
		...
		public override void AddRecipes()
		{
			...
			recipe1.AddIngredient(ItemID.CopperAxe, 1 ); // The required ingredients.
			...
			recipe2.AddIngredient(ItemID.TinAxe, 1 ); // The required ingredients.
